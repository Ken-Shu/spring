...
public class MyLogger {
	...
	public static void end(Method method , Object [] args) {
		System.out.println("後置通知 (方法名稱) : " + method.getName());
		System.out.println("後置通知 (查看參數) : " +Arrays.toString(args));
		System.out.println("後置通知 : 紀錄 log 2");	
	}
	//公用方法 (異常通知)
	public static void throwing(Exception errorMessage) {
		System.out.println("異常通知 : 紀錄 error" + errorMessage );	
	}
}
